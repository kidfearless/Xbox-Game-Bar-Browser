...
namespace App1
{
	...
	sealed partial class App : Application
	{
		...
		protected override void OnActivated(IActivatedEventArgs args)
		{
			...
			if (widgetArgs != null)
			{
				...
				if (widgetArgs.IsLaunchActivation)
				{
					...
					this.Widget = new XboxGameBarWidget(widgetArgs, Window.Current.CoreWindow, rootFrame);
					rootFrame.Navigate(typeof(MainWidget));

					Window.Current.Closed += MainWidget_Closed;
		...
		private void MainWidget_Closed(object sender, CoreWindowEventArgs e)
			=> Window.Current.Closed -= MainWidget_Closed;
		...
		protected override void OnLaunched(LaunchActivatedEventArgs e)
		{
			...
			if (e.PrelaunchActivated == false)
			{
				if (rootFrame.Content == null)
				{
					...
					// parameter
					rootFrame.Navigate(typeof(MainWidget), e.Arguments);
				}
